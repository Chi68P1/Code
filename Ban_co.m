...
clear all
BoardSize = 300;
SquareNumber = input('nhap so lieu ban co: '); 
SquareSize = BoardSize/SquareNumber; 
i0 = input('nhap hang X: '); j0 = input('nhap cot X: ');
i10 = input('nhap hang O: '); j10 = input('nhap cot O: ');
i = i0-1;
j = j0-1;
i1 = i10-1;
j1 = j10-1;
l01 = 100; l02 = 100;
l2 = 300; l3 = 200; l4 = 150; r = BoardSize/(4*SquareNumber); l1 = 100;
